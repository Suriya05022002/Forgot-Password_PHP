...
?>  
    ...
    <div class="container-fluid remove-vid-marg">
      ...
      <div class="vid-content" >
        <h1 class="my-content">GOWTHAMRAJ NETWORK</h1>
        <small class="my-content">Quality Education For Everyone</small><br />
        <?php    
              if(!isset($_SESSION['is_login'])){
                echo '<a class="btn btn-danger mt-3" href="#" data-toggle="modal" data-target="#stuRegModalCenter">Subscribe and Explore the World of Latest Techologies</a>';
              } else {
    ...
    <div class="container-fluid bg-danger txt-banner"> <!-- Start Text Banner -->
        <div class="row bottom-banner">
          ...
          <div class="col-sm">
            <h5><i class="fas fa-keyboard mr-3"></i>PAY ONLY SUBSCRIPTION FEE</h5>
          </div>
          <div class="col-sm">
            <h5><i class="fas fa-rupee-sign mr-3"></i>ACCESS UNLIMITED COURSES</h5>
          </div>
        </div>
    </div> <!-- End Text Banner -->
    ...
    <div class="container-fluid p-4" style="background-color:#E9ECEF">
      <div class="container" style="background-color:#E9ECEF">
        <div class="row text-center">
          <div class="col-sm">
            <h5>About Us</h5>
              <p>GOWTHAMRAJ NETWORK provides universal access to the world’s best education and offer courses online.</p>
          </div>
          <div class="col-sm">
            <h5>Category</h5>
          ...
          <div class="col-sm">
            <h5>Contact Us</h5>
            <p>GOWTHAMRAJ NETWORK<br> CHENNAI <br> TAMILNADU <br> info@gowthamrajnetwork.com </p>
          </div>
        </div>
      </div>
